...
echo 'tmux new -s minecraft_server 'java -Djava.awt.headless=true @$server_dir/user_jvm_args.txt @$server_dir/libraries/net/minecraftforge/forge/${version}/unix_args.txt "$@"'' >> "${management_dir}/start_server.sh"
