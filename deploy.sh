...
echo "tmux new -s ${name} '"java -Djava.awt.headless=true @user_jvm_args.txt @libraries/net/minecraftforge/forge/${version}/unix_args.txt"'" >> "${server_dir}/start_server.sh"
